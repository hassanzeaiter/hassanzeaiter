...
<p align="center">
  <b>Engineering Team Lead @ OLX Lebanon</b> · Senior Fullstack Developer &amp; Software Engineer
</p>
<p align="center">
  Building Laravel · React · Next.js and AI-driven products.
</p>

---

## 💫 About Me
- 🧭 I currently **lead the engineering team at OLX Lebanon** — driving architecture, delivery and code quality.
- 🔭 Senior **fullstack developer & software engineer** with years of shipping web platforms end-to-end.
- 👯 I'm looking to collaborate on **Laravel, React, and AI-driven projects**.
- 🌱 Currently learning **Next.js, multi-tenancy in SaaS, and AI model fine-tuning**.
- 🤝 Happy to chat about **AI model optimization for local deployment**.
...
<p align="center"><i>🗞️ Portfolio coming soon — a retro print/zine styled site is in the works.</i></p>
